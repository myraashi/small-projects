...
function startGame() {
    ...
    buttons.forEach((button, index) => {
      ...
      buttons[index].addEventListener("click", startGame);
...
function endGame(event) {
    ...
    statusDisplay.textContent = calcResult(playerMove, compterMove);
    ...
    moveDisplays[1].textContent = 'Computer played played${moveList[ComputerMove]}';
